...
Gem::Specification.new do |s|
  ...
  s.authors = ["Benjamin Wong", "Gary Or"]
  s.date = %q{2011-01-12}
  s.description = %q{Somatics3 is a collection of generators and extensions which reduces the effort of building admin panel for rails 3 resources.}
  s.email = %q{inspiresynergy@somaticsapp.com}
  ...
  s.homepage = %q{http://github.com/inspiresynergy/somatics3}
  ...
  s.summary = %q{Somatics3 - Admin Panel for Rails 3 Resources}
  s.test_files = [
    "test/helper.rb",
    "test/test_somatics3-generators.rb"
  ]
